...
<section id="breadcrumb" class="container">
  ...
  echo (display_breadcrumb(
      array(
          array("label"=>"Entry","url"=>"#","active"=>"false"),
          array("label"=>"Category Information","url"=>"category-list.php","active"=>"true")
      ))
  );
  ?>
</section>
...
<div class="container">
   <div class="row"> 
        <div class="col-xs-offset-1 col-sm-10 col-md-10 form_table"> 
            ...
            <div id="myDIV">
            <form id="CategoryList" name="CategoryList" class="new-form">
                <table class="table table-bordered">
                    ...
                    <?php $i = 1; foreach ($data as $value) { ?>
                      ...
                      <tr>
                        <td class="check" ><label><input type="checkbox" id="delCheck[]" name="delCheck[]" value="<?php echo $value["CategoryID"] ?>"/>&nbsp;<?php echo($i);?></label></td>
                        <td><?php echo($value['CategoryID']); ?></td>
                        <td><?php echo($value['CategoryName']); ?></td>
                        <td class="check"><button type="button" class="btn edit" onclick="show_edit('<?php echo( $value["CategoryID"] ) ?>')">Edit</button></td>
                      </tr>
...
<script lang="javascript" type="text/javascript">
        ...
        {
            window.open('category-edit.php?id='+ id,'_self');
        }

        function show_entry()
        {
            window.open('category-entry.php','_self');
        }
