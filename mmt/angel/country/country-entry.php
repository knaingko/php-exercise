...
<div class="container">
  <div class="row para">  
    ...
    <h2 class="info-h2">Country Information:</h2>
      <form role="form" id="CountryForm" name="CountryForm">
        <table class="table table-borderless">
          <tr>
            <td>Country ID:</td>
            <td><input type="text" class="form-control input-sm" name="country_id" id="country_id" value="" placeholder="Enter country id" required /></td>
          </tr>
          <tr>
            <td>Country Name:</td>
            <td><input type="text" class="form-control input-sm" name="country_name" id="country_name" value="" placeholder="Enter country name" required /></td>
          </tr>                   
          <tr>
          <td></td>
            <td><button type="button" class="btn save" onclick="SaveData()">Save</button>&nbsp;
            <button type="button" class="btn save" onclick="window.open('country-list.php','_self');">Cancel</button>
            </td>
          </tr>
        </table>
      </form>
