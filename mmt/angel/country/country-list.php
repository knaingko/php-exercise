...
<div class="container">
   <div class="row"> 
        <div class="col-xs-offset-1 col-sm-10 col-md-10 form_table"> 
            ...
            <div id="myDIV">
            <form id="CountryList" name="CountryList" class="new-form">
                <table class="table table-bordered">
                    ...
                    <?php $i = 1; foreach ($data as $value) { ?>
                      ...
                      <tr>
                        <td class="check" ><label><input type="checkbox" id="delCheck[]" name="delCheck[]" value="<?php echo $value["CountryID"] ?>"/>&nbsp;<?php echo($i);?></label></td>
                        <td><?php echo($value['CountryID']); ?></td>
                        <td><?php echo($value['CountryName']); ?></td>
                        <td class="check"><button type="button" class="btn edit" onclick="show_edit('<?php echo( $value["CountryID"] ) ?>')">Edit</button></td>
                      </tr>
