      ...
      <h2>Country Edit Form</h2>
        <form role="form" id="CountryForm" name="CountryForm">
          <table class="table table-borderless">
            <tr>
              <td>Country ID:</td>
              <td><input type="text" class="form-control input-sm" name="country_id" id="country_id" value="<?php echo($Id);?>" placeholder="Enter country id" required /></td>
            </tr>
            <tr>
              <td>Country Name:</td>
              <td><input type="text" class="form-control input-sm" name="country_name" id="country_name" value="<?php echo($Name);?>" placeholder="Enter country name" required /></td>
            </tr>                    
            <tr>
              <td></td>
