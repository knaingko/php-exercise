    ...
    <div class="container">
      <div class="row text-center">
        <div class="col-xs-12 col-sm-3 col-md-3 res">
          ...
          <h2>CATEGORIES</h2>
            <ul>
              <li><a href="portfolio.php">Beach</a></li>
              <li  class="act"><a href="scence.php">Scence</a></li>	
              <li><a href="landmask.php">Landmask</a></li>	
              <li><a href="pagoda.php">Pagoda</a></li>
              <li><a href="museum.php">Museum</a></li>
              <li><a href="live.php">Live(daily)</a></li>
              <li><a href="macro.php">Macro</a></li>
              <li><a href="festival.php">Festival</a></li>
            </ul>
          </div>
        </div> 
        <div class="col-xs-12 col-sm-9 col-md-9 res">
          <h3 class="m_1"><a href="scence.php">Scence</a></h3>
          <div class="row">
            <div class="col-xs-6 col-sm-4 col-md-4 res">                
            <img class="img-responsive img para images animated zoomIn" src="images/images5.jpg" alt="" />
          ...
          <div class="row">
            <div class="col-xs-6 col-sm-4 col-md-4 res">                
            <img class="img-responsive img para images animated zoomIn" src="images/images5.jpg" alt="" /></a>
            <p class="product"> Ngwe Saung Beach<br />
            5000ks<br />
            </p>
            <div class="follow-us"><a class="fa fa-shopping-cart shopping" href="#"></a><a class="fa fa-heart shopping" href="#"></a></div>
